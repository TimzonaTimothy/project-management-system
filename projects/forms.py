...
class ProjectRegistrationForm(forms.ModelForm):
    ...
    project_id = forms.CharField(max_length=10)
    ...
    def save(self, commit=True):
        ...
        Project.project_id = self.cleaned_data['project_id']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['project_id'].widget.attrs['class'] = 'form-control'
        self.fields['project_id'].widget.attrs['placeholder'] = 'Project ID'
